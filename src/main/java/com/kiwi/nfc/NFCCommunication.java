...
public class NFCCommunication implements Runnable{
	...
	public NFCCommunication(ServerCommunication serverComm) {
	...
	public void run() {
		...
		while(true) {
			...
			while(true) {
					...
					serverComm.sendDisconnectionMessage(uid);
			}
		}
	}
